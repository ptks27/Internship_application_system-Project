  ...
  resources: {
    ...
    th: {
      translation: {
        ...
        errorDeletingNotification: "เกิดข้อผิดพลาดในการลบกรแจ้งเตือน",
        on: "เมื่อ",
        ...
        bioPlaceholder: "เลือประวัติย่อของคุณ (สูงสุด 3 รายการ)",
        ...
        accountNotExistWithRole: "ไม่พบบัญชีผู้ใช้สำหรับบทบาทนี้",
        fillInformationCompletely: "กรุณากรอกข้อมูลให้ครบถ้วน",
        incorrectEmailOrPassword: "อีเมลหรือรหัสผ่านไม่ถูกต้อง",
        verifyEmailBeforeLogin: "กรุณายืนยันอีเมลของคุณก่อนเข้าสู่ระบบ",
        FILL_INFORMATION_COMPLETELY: "กรุณากรอกข้อมูลในช่องที่ต้องกรอกทั้งหมด",
        INVALID_USER_ID: "ID ผู้ใช้ไม่ถูกต้อง",
        INVALID_COMPANY_ID: "รหัสบริษัทไม่ถูกต้อง",
        INVALID_JOB_TYPE: "ประเภทงานไม่ถูกต้อง",
        JOB_CREATED_SUCCESSFULLY: "สร้างงานใหม่สำเร็จแล้ว",
        VALIDATION: {
          JOB_POSITION_REQUIRED: "กรุณาระบุตำแหน่งงาน",
          JOB_POSITION_MIN_LENGTH:
            "ตำแหน่งงานต้องมีความยาวอย่างน้อย 3 ตัวอักษร",
          DESCRIPTION_REQUIRED: "กรุณาระบุรายละเอียดงาน",
          DESCRIPTION_MIN_LENGTH:
            "รายละเอียดงานต้องมีความยาวอย่างน้อย 20 ตัวอักษร",
          DESCRIPTION_MAX_LENGTH: "รายละเอียดงานต้องไม่เกิน 400 ตัวอักษร",
          LOCATION_REQUIRED: "กรุณาระบุสถานที่",
          SALARY_REQUIRED: "กรุณาระบุเงินเดือน",
          SALARY_MUST_BE_NUMBER: "เงินเดือนต้องเป็นตัวเลขเท่านั้น",
          SALARY_MAX_LENGTH: "เงินเดือนต้องไม่เกิน 10 หลัก",
          JOB_TYPE_REQUIRED: "กรุณาระบุประเภทงาน",
          EXPERIENCE_REQUIRED: "กรุณาระบุระดับประสบการณ์",
          EXPERIENCE_MUST_BE_NUMBER: "ประสบการณ์ต้องเป็นตัวเลขเท่านั้น",
          POSITION_REQUIRED: "กรุณาระบุจำนวนตำแหน่งที่เปิดรับ",
          POSITION_MUST_BE_NUMBER: "จำนวนตำแหน่งต้องเป็นัวเลขเท่านั้น",
          COMPANY_REQUIRED: "กรุณาระบุบริษัท",
        },
        JOB_NOT_FOUND_OR_NO_PERMISSION:
          "ไม่พบงานหรือคุณไม่มีสิทธิ์ในการลบงานนี้",
        JOB_UPDATED_SUCCESSFULLY: "อัปเดตงานสำเร็จ",
        INTERNAL_SERVER_ERROR: "เกิดข้อผิดพลาดภายในเซิร์ฟเวอร์",
        JOB_DELETED_SUCCESSFULLY: "ลบงานสำเร็จ",
        pleaseCorrectFormErrors: "กรุณาแก้ไขข้อผิดพลาดในแบบฟอร์ม",
        COMPANY_NOT_FOUND: "ไม่พบบริษัท",
        COMPANY_UPDATED_SUCCESSFULLY: "แก้ไขข้อมูลบริษัทสำเร็จ",
        COMPANY_DELETED_SUCCESSFULLY: "ลบบริษัทสำเร็จ",
        ERROR_DELETING_COMPANY: "เกิดข้อผิดพลาดในการลบบริษัท",
        STATUS_UPDATED_SUCCESSFULLY: "อัปเดตสถานะสำเร็จ",
      },
    },
  },
