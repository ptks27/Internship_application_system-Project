      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">THE TRAINEE.</h2>
            <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a target="_blank" href="https://www.facebook.com/basPtkk/" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a target="_blank" href="https://www.linkedin.com/in/phonthakon-saengthongkoed-420a97321/" className="hover:text-gray-400" aria-label="LinkedIn">
            ...
            <a target="_blank" href="https://github.com/ptks27" className="hover:text-gray-400" aria-label="GitHub">
